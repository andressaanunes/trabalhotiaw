...
function getProds() {
    ...
    const prods = fetch(`/search/${params[1]}`).then((res)=>{    
        console.log(prods)
        console.log(res)
        ...
        prods.forEach(prod => {
            ...
            <div id= "columns" class="card h-100">
                ...
                <div class="card-body">
                    <h4 class="card-title"><a class="text-decoration-none" href="/produto?product=${prod.id}" title="View Product">${prod.nome}</a></h4>
