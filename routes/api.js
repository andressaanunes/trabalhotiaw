...
router.use((req,res,next) => {
    ...
    res.header({"Access-Control-Allow-Origin":"http://www.crialuth.com/, http://localhost:21090/",//tirar o asterisco e usar o site pra testar oq vai ser barrado, e adicionar a url do q for barrado na lista de "Access-Control-Allow-Origin"
